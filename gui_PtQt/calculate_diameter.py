...
from gui_PtQt.small_widgets import SimpleDoubleSpinBox, BaseDataDialog
from PyQt5.QtCore import QSettings
from gui_PtQt.configuration.config import defaults, references
from .reference_manager import ReferenceManagerWindow
from core.functions.gui_functions import add_category
