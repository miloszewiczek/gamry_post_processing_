...
from core.managers.experiment_loader import ExperimentLoader
from gui_PtQt.configuration.config import references, icon_path
from gui_PtQt.plotting_area import OCPPlot, PlottingCanvas
from core.functions.gui_functions import load_files, shorten_path
...
class ReferenceManagerWindow(BaseDataDialog):
    ...
    def add_measurement(self):
        ...
        if offset:
            ...
            self.update_combobox(event = self.references_types.currentText())
